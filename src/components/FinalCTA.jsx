...
const FinalCTA = () => {
  ...
  return (
    <section className="py-20 md:py-28 relative overflow-hidden bg-[#0A0F1C]">
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
        <motion.div
          ...
          className="bg-[#111827]/60 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-8 md:p-16 shadow-[0_0_50px_rgba(255,79,163,0.1)]"
        >
            ...
            <Link to="/contact">
              <button 
                className="w-full sm:w-auto bg-gradient-to-r from-[#FF4FA3] to-[#FF2D8D]
                           ...
                           shadow-[0_0_24px_rgba(255,79,163,0.4)]
                           hover:shadow-[0_0_45px_rgba(255,79,163,0.6)]
                           hover:scale-105 active:scale-95
                           transition-all duration-300 text-base md:text-lg min-h-[52px]"
              >
                {t("cta.primaryBtn")}
              </button>
            </Link>
            <Link to="/contact">
              <button 
                className="w-full sm:w-auto bg-white/5 border border-white/10 text-white 
                           ...
                           hover:border-[#FF4FA3]/40 transition-all duration-300 text-base md:text-lg min-h-[52px]"
              >
                {t("cta.secondaryBtn")}
              </button>
            </Link>
